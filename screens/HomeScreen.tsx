import { StyleSheet, View, Text, ScrollView, Pressable, SafeAreaView, Animated } from 'react-native';
...
export default function DrinkDetailScreen({
	...
	return (
		<SafeAreaView style={styles.topContainer}>
			<View style={{ width: Dimensions.width * 390, height: Dimensions.height * 44,paddingHorizontal:10,backgroundColor: Colors.White, justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row' }}>
			...
			<View style={{ width: Dimensions.width * 390, height: Dimensions.height * 164,justifyContent:'center',alignItems:'center',backgroundColor:Colors.White}}>
				...
				<Text style={{fontSize:14,marginTop:14}}>"이 정도면 적당해요!"</Text>
			</View>
